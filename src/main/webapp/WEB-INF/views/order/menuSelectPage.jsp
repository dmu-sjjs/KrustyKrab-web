...
<div id="selectPage">
    ...
    <form id="addForm" action="/order/${storeId}/addItem" method="post" >
        ...
        메뉴명 <input placeholder="원하는 메뉴를 클릭하세요!" required readonly type="text" id="menuName" name="menuName"><br>
        개수 <input placeholder="수량을 입력하세요" required type="number" id="count" name="count">
